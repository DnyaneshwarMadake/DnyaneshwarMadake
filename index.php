...
<body class="bg-image" style="background-image: url('https://media.istockphoto.com/photos/glass-and-steel-bank-corporate-building-picture-id479137569?k=20&m=479137569&s=612x612&w=0&h=BvDTNacQC_LASRgqjLKHvBAPuh4oxH9jygPGDxCW5O4=');height:100vh;background-repeat: no-repeat;background-size:cover ;background-position: center;">
...
<footer class="page-footer font-small blue fixed-bottom text-white">
          <div class="footer-copyright text-center py-3">
            <p> ©  Copyright Sept 2021 || All Right Reserve || Dnyaneshwar Madake</p>
          </div>
</footer>
